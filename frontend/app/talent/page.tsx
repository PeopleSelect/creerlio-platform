    ...
    <div className="min-h-screen bg-white text-gray-900 relative">
      ...
      <section className="max-w-7xl mx-auto px-8 py-16">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-md border border-gray-100">
            ...
            <h3 className="text-xl font-bold text-[#2563EB] mb-5">Visibility and Opportunities</h3>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-md border border-gray-100">
            ...
            <h3 className="text-xl font-bold text-[#2563EB] mb-5">Maintain Control of your Privacy and Information</h3>
            <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
              <div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-md border border-gray-100">
            ...
            <h3 className="text-xl font-bold text-[#2563EB] mb-5">Wasted Time in the Job Search Process</h3>
            <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
              <div>
      ...
      <section className="max-w-7xl mx-auto px-8 py-12">
        <div className="text-center">
          <Link
            href="/login/talent?mode=signup&redirect=/dashboard/talent"
            className="inline-block px-12 py-4 rounded-lg bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-semibold text-lg transition-colors shadow-md"
          >
      ...
      <Link
        ...
        className="fixed bottom-6 right-6 z-50 px-5 py-3 rounded-full bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-semibold text-sm shadow-lg transition-colors"
      >
        CHAT WITH US
      </Link>
    </div>
