  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        what_company_does: profile.what_company_does.trim(),
        culture_values: profile.culture_values.trim(),
        work_environment: profile.work_environment.trim(),
        typical_roles: profile.typical_roles.trim(),
        website: profile.website.trim(),
        logo_url: profile.logo_url.trim(),
        banner_url: profile.banner_url.trim(),
