          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-1">
                ...
                <button onClick={() => router.push('/talent/jobs')} className="px-4 py-2 text-amber-700 bg-amber-50 rounded-lg text-sm font-medium">
                  Job Search
                </button>
            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <span className="px-3 py-1 bg-amber-50 text-amber-700 rounded-full text-sm">Full-time</span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">Remote</span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">$120k - $180k</span>
                </div>
                <p className="mt-4 text-gray-600 line-clamp-2">
                  We're looking for an experienced software engineer to join our growing team...
                </p>
              </div>
              <button onClick={() => router.push('/talent/jobs/1/apply')} className="ml-4 px-6 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 font-medium">
                Apply
              </button>
            </div>
          </div>
            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  ...
                  <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">$100k - $140k</span>
                </div>
                <p className="mt-4 text-gray-600 line-clamp-2">
                  Join our innovative startup and help build the next generation of web applications...
                </p>
              </div>
              <button onClick={() => router.push('/talent/jobs/2/apply')} className="ml-4 px-6 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 font-medium">
                Apply
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <span className="px-3 py-1 bg-amber-50 text-amber-700 rounded-full text-sm">Contract</span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">Remote</span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">$80k - $120k</span>
                </div>
                <p className="mt-4 text-gray-600 line-clamp-2">
                  Work on exciting client projects with cutting-edge frontend technologies...
                </p>
              </div>
              <button onClick={() => router.push('/talent/jobs/3/apply')} className="ml-4 px-6 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 font-medium">
                Apply
              </button>
            </div>
          </div>
