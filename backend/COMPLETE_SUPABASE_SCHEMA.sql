-- =====================================================
-- COMPLETE CREERLIO PLATFORM DATABASE SCHEMA
-- PostgreSQL (Supabase)
-- 80 Tables Total: 73 Platform + 7 Identity
...
CREATE TABLE "PortfolioSections" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
    "PortfolioTemplateId" uuid NOT NULL,
    "Type" text NOT NULL DEFAULT '',
    "Title" text NOT NULL DEFAULT '',
...
CREATE TABLE "PortfolioSharings" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
    "TalentProfileId" uuid NOT NULL,
...
CREATE TABLE "BusinessVerifications" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE "SubscriptionInfos" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE "TeamMemberRatings" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE "MarketIntelligences" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE "BusinessIntelligenceReports" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
    "BusinessProfileId" uuid NOT NULL,
...
CREATE TABLE "ElectronicFootprints" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
    "TalentProfileId" uuid NOT NULL,
...
CREATE TABLE "SpeakingEngagements" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
    "TalentProfileId" uuid NOT NULL,
...
CREATE TABLE "AwardRecognitions" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
    "TalentProfileId" uuid NOT NULL,
    "Title" text NOT NULL DEFAULT '',
    "Issuer" text NOT NULL DEFAULT '',
...
CREATE TABLE "CredentialVerifications" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
    "TalentProfileId" uuid NOT NULL,
...
CREATE TABLE "VerificationSources" (
    "Id" uuid PRIMARY KEY NOT NULL DEFAULT gen_random_uuid(),
...
CREATE INDEX "IX_Cities_Postcode" ON "Cities" ("Postcode");
CREATE INDEX "IX_Cities_Latitude_Longitude" ON "Cities" ("Latitude", "Longitude");
CREATE UNIQUE INDEX "IX_Industries_Name" ON "Industries" ("Name");
CREATE INDEX "IX_JobCategories_IndustryId_Name" ON "JobCategories" ("IndustryId", "Name");
CREATE UNIQUE INDEX "IX_Universities_Name" ON "Universities" ("Name");
CREATE INDEX "IX_TAFEInstitutes_Name" ON "TAFEInstitutes" ("Name");
CREATE INDEX "IX_CredentialTypes_Category_Name" ON "CredentialTypes" ("Category", "Name");
CREATE INDEX "IX_VisaTypes_SubclassCode" ON "VisaTypes" ("SubclassCode");
CREATE INDEX "IX_SkillDefinitions_Category_Name" ON "SkillDefinitions" ("Category", "Name");

-- Talent profile indexes
CREATE UNIQUE INDEX "IX_TalentProfiles_UserId" ON "TalentProfiles" ("UserId");

-- Business profile indexes
CREATE UNIQUE INDEX "IX_BusinessProfiles_UserId" ON "BusinessProfiles" ("UserId");

-- Job matching indexes
CREATE UNIQUE INDEX "IX_JobMatches_TalentProfileId_JobPostingId" ON "JobMatches" ("TalentProfileId", "JobPostingId");
CREATE INDEX "IX_JobMatches_TalentProfileId_MatchScore" ON "JobMatches" ("TalentProfileId", "MatchScore");

-- Electronic footprint indexes
CREATE UNIQUE INDEX "IX_ElectronicFootprints_TalentProfileId" ON "ElectronicFootprints" ("TalentProfileId");

-- Application indexes
CREATE INDEX "IX_Applications_JobPostingId_Status" ON "Applications" ("JobPostingId", "Status");
CREATE INDEX "IX_Applications_TalentProfileId" ON "Applications" ("TalentProfileId");

-- Job posting indexes
CREATE INDEX "IX_JobPostings_BusinessProfileId_Status" ON "JobPostings" ("BusinessProfileId", "Status");

-- Career pathway indexes
CREATE INDEX "IX_CareerPathways_TalentProfileId" ON "CareerPathways" ("TalentProfileId");

-- Search indexes
CREATE INDEX "IX_SavedSearches_TalentProfileId" ON "SavedSearches" ("TalentProfileId");
CREATE INDEX "IX_TalentPools_BusinessProfileId" ON "TalentPools" ("BusinessProfileId");
